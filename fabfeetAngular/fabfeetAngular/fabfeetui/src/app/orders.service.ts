...
export class OrdersService {
  ...
  loadOrdersDetailsByAsc():Observable<Orders[]>{
    return this.httpClient.get<Orders[]>("http://localhost:9090/orders/priceasc")
  }
  loadOrdersDetailsByDesc():Observable<Orders[]>{
    return this.httpClient.get<Orders[]>("http://localhost:9090/orders/pricedesc")
  }
}
