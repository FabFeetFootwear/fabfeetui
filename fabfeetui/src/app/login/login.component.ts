...
export class LoginComponent implements OnInit {
  ...
  constructor(public router:Router,public customerService:CustomerService,public store:UserService) { }   //DI for Router which help to do routing programmatially
